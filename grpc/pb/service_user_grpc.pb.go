...
const (
	UserService_GreetUser_FullMethodName = "/pb.UserService/GreetUser"
)
...
func (c *userServiceClient) GreetUser(ctx context.Context, in *GreetUserRequest, opts ...grpc.CallOption) (*GreetUserResponse, error) {
...
func (UnimplementedUserServiceServer) GreetUser(context.Context, *GreetUserRequest) (*GreetUserResponse, error) {
...
func _UserService_GreetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GreetUser(ctx, req.(*GreetUserRequest))
	}
